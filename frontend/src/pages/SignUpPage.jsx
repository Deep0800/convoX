...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* left side */}
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 mt-4">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-base-content/60">Fast, Secure, and Always On!</p>
          </div>
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    ...
                    <Eye className="size-5 text-base-content/40 cursor-pointercursor-pointer" />
                  )}
                </button>
              </div>
            </div>
